...
import { AddAndEditTimerModal } from './AddAndEditTimerModal';
  ...
  if (timer.isRunning) {
    intervalRef.current = window.setInterval(() => {
      ...
      if (timer.remainingTime <= 1 && !hasEndedRef.current) {
        ...
        const playAudio = () => timerAudio.play().catch(console.error);
        let count = 0;
        const repeatAudio = setInterval(() => {
          if (count < 5) {
            playAudio();
            count++;
          } else {
        ...
        <div className="relative">
          ...
          <div className="flex flex-col items-center mt-6">
            ...
            <TimerControls
              ...
              onToggle={handleToggle}  // Ensure it toggles each timer independently
